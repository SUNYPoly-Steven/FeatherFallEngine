...
__9D423237_simplerendererscene.h DB 01H
__2BBF8BDD_simplerendererscene.cpp DB 01H
...
PUBLIC	??_C@_0CG@GOLBIJHJ@res?1shaders?1SimpleRendererTest?4@ ; `string'
PUBLIC	??_C@_0CM@HPDNAKJM@SimpleRenderer2D?5is?5BROKEN?$CB?5PLE@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0CM@HPDNAKJM@SimpleRenderer2D?5is?5BROKEN?$CB?5PLE@
CONST	SEGMENT
??_C@_0CM@HPDNAKJM@SimpleRenderer2D?5is?5BROKEN?$CB?5PLE@ DB 'SimpleRende'
	DB	'rer2D is BROKEN! PLEASE FIX ME!!', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0CG@GOLBIJHJ@res?1shaders?1SimpleRendererTest?4@
CONST	SEGMENT
??_C@_0CG@GOLBIJHJ@res?1shaders?1SimpleRendererTest?4@ DB 'res/shaders/Si'
	DB	'mpleRendererTest.shader', 00H		; `string'
CONST	ENDS
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?OnUpdate@SimpleRendererScene@Scene@Application@@UEAAXM@Z DD 025031501H
	DD	0b2102315H
	DD	0500cH
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$ip2state$??1SimpleRendererScene@Scene@Application@@UEAA@XZ DD imagerel ??1SimpleRendererScene@Scene@Application@@UEAA@XZ
	DD	0ffffffffH
xdata	ENDS
;	COMDAT CONST
CONST	SEGMENT
$cppxdata$??1SimpleRendererScene@Scene@Application@@UEAA@XZ DD 019930522H
	DD	00H
	DD	00H
	DD	00H
	DD	00H
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$??1SimpleRendererScene@Scene@Application@@UEAA@XZ DD 025041a19H
	DD	010d2312H
	DD	050060012H
	DD	imagerel __CxxFrameHandler3
...
$ip2state$??0SimpleRendererScene@Scene@Application@@QEAA@XZ DD imagerel ??0SimpleRendererScene@Scene@Application@@QEAA@XZ
	DD	0ffffffffH
	DD	imagerel ??0SimpleRendererScene@Scene@Application@@QEAA@XZ+64
	DD	00H
	DD	imagerel ??0SimpleRendererScene@Scene@Application@@QEAA@XZ+274
	DD	01H
	DD	imagerel ??0SimpleRendererScene@Scene@Application@@QEAA@XZ+387
	DD	00H
	DD	imagerel ??0SimpleRendererScene@Scene@Application@@QEAA@XZ+409
	DD	02H
	DD	imagerel ??0SimpleRendererScene@Scene@Application@@QEAA@XZ+433
	DD	03H
	DD	imagerel ??0SimpleRendererScene@Scene@Application@@QEAA@XZ+470
	DD	02H
	DD	imagerel ??0SimpleRendererScene@Scene@Application@@QEAA@XZ+481
	DD	03H
	DD	imagerel ??0SimpleRendererScene@Scene@Application@@QEAA@XZ+492
	DD	04H
	DD	imagerel ??0SimpleRendererScene@Scene@Application@@QEAA@XZ+500
	DD	00H
	DD	imagerel ??0SimpleRendererScene@Scene@Application@@QEAA@XZ+546
	DD	05H
	DD	imagerel ??0SimpleRendererScene@Scene@Application@@QEAA@XZ+627
	DD	00H
	DD	imagerel ??0SimpleRendererScene@Scene@Application@@QEAA@XZ+662
	DD	06H
	DD	imagerel ??0SimpleRendererScene@Scene@Application@@QEAA@XZ+934
	DD	00H
	DD	imagerel ??0SimpleRendererScene@Scene@Application@@QEAA@XZ+952
	DD	0ffffffffH
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
...
$LN3:
	...
	sub	rsp, 96					; 00000060H
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__2BBF8BDD_simplerendererscene.cpp
	call	__CheckForDebuggerJustMyCode
...
; 53   : 		ImGui::Text("SimpleRenderer2D is BROKEN! PLEASE FIX ME!!");
	...
	lea	rcx, OFFSET FLAT:??_C@_0CM@HPDNAKJM@SimpleRenderer2D?5is?5BROKEN?$CB?5PLE@
...
; 17   : 		core::graphics::Shader* shader = new core::graphics::Shader("res/shaders/SimpleRendererTest.shader");
	...
	je	SHORT $LN5@SimpleRend
	lea	rdx, OFFSET FLAT:??_C@_0CG@GOLBIJHJ@res?1shaders?1SimpleRendererTest?4@
