...
PUBLIC	??_C@_0EP@NKMMIOEK@l?3?2dev?2featherfallengine?2feather@ ; `string'
PUBLIC	??_C@_0BH@KNBBAFPG@glGenTextures?$CI1?0?5?$CGtex?$CJ?$AA@ ; `string'
PUBLIC	??_C@_0FB@HJAEJJFP@glTexImage2D?$CIGL_TEXTURE_2D?0?50?0?5G@ ; `string'
...
PUBLIC	??_C@_0CF@GNFBDKCB@glDispatchCompute?$CI512?116?0?5512?116@ ; `string'
...
PUBLIC	??_C@_0CG@HONEABJK@glDrawArrays?$CIGL_TRIANGLE_STRIP?0?5@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0CG@HONEABJK@glDrawArrays?$CIGL_TRIANGLE_STRIP?0?5@
CONST	SEGMENT
??_C@_0CG@HONEABJK@glDrawArrays?$CIGL_TRIANGLE_STRIP?0?5@ DB 'glDrawArray'
	DB	's(GL_TRIANGLE_STRIP, 0, 4)', 00H		; `string'
CONST	ENDS
...
_DATA	ENDS
;	COMDAT ??_C@_0CF@GNFBDKCB@glDispatchCompute?$CI512?116?0?5512?116@
CONST	SEGMENT
??_C@_0CF@GNFBDKCB@glDispatchCompute?$CI512?116?0?5512?116@ DB 'glDispatc'
	DB	'hCompute(512/16, 512/16, 1)', 00H		; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0FB@HJAEJJFP@glTexImage2D?$CIGL_TEXTURE_2D?0?50?0?5G@
CONST	SEGMENT
??_C@_0FB@HJAEJJFP@glTexImage2D?$CIGL_TEXTURE_2D?0?50?0?5G@ DB 'glTexImag'
	DB	'e2D(GL_TEXTURE_2D, 0, GL_RGBA32F, 512, 512, 0, GL_RGBA, GL_FL'
	DB	'OAT, NULL)', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@KNBBAFPG@glGenTextures?$CI1?0?5?$CGtex?$CJ?$AA@
CONST	SEGMENT
??_C@_0BH@KNBBAFPG@glGenTextures?$CI1?0?5?$CGtex?$CJ?$AA@ DB 'glGenTextur'
	DB	'es(1, &tex)', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0EP@NKMMIOEK@l?3?2dev?2featherfallengine?2feather@
CONST	SEGMENT
??_C@_0EP@NKMMIOEK@l?3?2dev?2featherfallengine?2feather@ DB 'l:\dev\feath'
	DB	'erfallengine\featherfall-examples\src\scene\computeshaderscen'
	DB	'e.cpp', 00H					; `string'
CONST	ENDS
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$??1ComputeShaderScene@Scene@Application@@UEAA@XZ DD 025041201H
	DD	010d2312H
	DD	050060012H
xdata	ENDS
;	COMDAT xdata
...
$ip2state$??0ComputeShaderScene@Scene@Application@@QEAA@XZ DD imagerel ??0ComputeShaderScene@Scene@Application@@QEAA@XZ
	DD	0ffffffffH
	DD	imagerel ??0ComputeShaderScene@Scene@Application@@QEAA@XZ+69
	DD	00H
	DD	imagerel ??0ComputeShaderScene@Scene@Application@@QEAA@XZ+100
	DD	01H
	DD	imagerel ??0ComputeShaderScene@Scene@Application@@QEAA@XZ+124
	DD	02H
	DD	imagerel ??0ComputeShaderScene@Scene@Application@@QEAA@XZ+161
	DD	01H
	DD	imagerel ??0ComputeShaderScene@Scene@Application@@QEAA@XZ+172
	DD	02H
	DD	imagerel ??0ComputeShaderScene@Scene@Application@@QEAA@XZ+183
	DD	03H
	DD	imagerel ??0ComputeShaderScene@Scene@Application@@QEAA@XZ+198
	DD	00H
	DD	imagerel ??0ComputeShaderScene@Scene@Application@@QEAA@XZ+244
	DD	04H
	DD	imagerel ??0ComputeShaderScene@Scene@Application@@QEAA@XZ+274
	DD	05H
	DD	imagerel ??0ComputeShaderScene@Scene@Application@@QEAA@XZ+317
	DD	04H
	DD	imagerel ??0ComputeShaderScene@Scene@Application@@QEAA@XZ+328
	DD	05H
	DD	imagerel ??0ComputeShaderScene@Scene@Application@@QEAA@XZ+342
	DD	06H
	DD	imagerel ??0ComputeShaderScene@Scene@Application@@QEAA@XZ+360
	DD	00H
	DD	imagerel ??0ComputeShaderScene@Scene@Application@@QEAA@XZ+1067
	DD	0ffffffffH
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
...
; 75   : 		ImGui::Text("This is animation is\nbeing calculated on the GPU\nusing compute shaders!!");
	...
	lea	rcx, OFFSET FLAT:??_C@_0EJ@PCBKELCC@This?5is?5animation?5is?6being?5calcu@
...
; 76   : 		ImGui::Text("Time: %.3f\nDeltaTime: %.3f", time, lastDelta);
	...
	movq	r8, xmm2
	movq	rdx, xmm1
	lea	rcx, OFFSET FLAT:??_C@_0BL@JJNDJILN@Time?3?5?$CF?43f?6DeltaTime?3?5?$CF?43f?$AA@
	call	?Text@ImGui@@YAXPEBDZZ			; ImGui::Text
...
; 70   : 		GLCall(glDrawArrays(GL_TRIANGLE_STRIP, 0, 4));
	...
	add	eax, 2
	mov	r8d, eax
	lea	rdx, OFFSET FLAT:??_C@_0EP@NKMMIOEK@l?3?2dev?2featherfallengine?2feather@
	lea	rcx, OFFSET FLAT:??_C@_0CG@HONEABJK@glDrawArrays?$CIGL_TRIANGLE_STRIP?0?5@
...
; 63   : 		compute->setUniform1f("roll", time);
	...
	lea	rdx, OFFSET FLAT:??_C@_04FBAPEKPH@roll?$AA@
	mov	rax, QWORD PTR this$[rbp]
	mov	rcx, QWORD PTR [rax+8]
...
; 64   : 		GLCall(glDispatchCompute(512/16, 512/16, 1)); //512^2 threads in 16^2 blocks
	...
	mov	r8d, eax
	lea	rdx, OFFSET FLAT:??_C@_0EP@NKMMIOEK@l?3?2dev?2featherfallengine?2feather@
	lea	rcx, OFFSET FLAT:??_C@_0CF@GNFBDKCB@glDispatchCompute?$CI512?116?0?5512?116@
	call	?GLLogError@@YA_NPEBD0H@Z		; GLLogError
	movzx	eax, al
	test	eax, eax
...
; 9    : 		: compute(new core::graphics::Shader("res/shaders/c_HelloCompute.shader")),
	...
	je	SHORT $LN5@ComputeSha
	lea	rdx, OFFSET FLAT:??_C@_0CC@PDJMHILO@res?1shaders?1c_HelloCompute?4shade@
...
; 10   : 		gfx(new core::graphics::Shader("res/shaders/g_HelloCompute.shader"))
	...
	lea	rdx, OFFSET FLAT:??_C@_0CC@KPDNOLLO@res?1shaders?1g_HelloCompute?4shade@
...
; 33   : 		GLCall(glGenTextures(1, &tex));
	...
	mov	r8d, eax
	lea	rdx, OFFSET FLAT:??_C@_0EP@NKMMIOEK@l?3?2dev?2featherfallengine?2feather@
	lea	rcx, OFFSET FLAT:??_C@_0BH@KNBBAFPG@glGenTextures?$CI1?0?5?$CGtex?$CJ?$AA@
	call	?GLLogError@@YA_NPEBD0H@Z		; GLLogError
	movzx	eax, al
	test	eax, eax
...
; 39   : 		GLCall(glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA32F, 512, 512, 0, GL_RGBA, GL_FLOAT, NULL));
	...
	mov	r8d, eax
	lea	rdx, OFFSET FLAT:??_C@_0EP@NKMMIOEK@l?3?2dev?2featherfallengine?2feather@
	lea	rcx, OFFSET FLAT:??_C@_0FB@HJAEJJFP@glTexImage2D?$CIGL_TEXTURE_2D?0?50?0?5G@
	call	?GLLogError@@YA_NPEBD0H@Z		; GLLogError
	movzx	eax, al
	test	eax, eax
...
; 46   : 		gfx->setUniform1i("srcTex", 0);
	...
	xor	r8d, r8d
	lea	rdx, OFFSET FLAT:??_C@_06MKPOCJKA@srcTex?$AA@
	mov	rax, QWORD PTR this$[rbp]
	mov	rcx, QWORD PTR [rax+16]
...
; 49   : 		compute->setUniform1i("destTex", 0);//set the image2D to use texture slot 0
	...
	xor	r8d, r8d
	lea	rdx, OFFSET FLAT:??_C@_07HLIDLGDF@destTex?$AA@
	mov	rax, QWORD PTR this$[rbp]
	mov	rcx, QWORD PTR [rax+8]
	call	?setUniform1i@Shader@graphics@core@@QEAAXPEBDH@Z ; core::graphics::Shader::setUniform1i
	npad	1
